    ...
    <!--  #  sidebar   # -->
      ...
      <div class="main-panel"> <!--3. main panel starts-->
        <div class="content-wrapper"> <!-- 4. content wrapper starts-->
                ...
                <?php  $query=$admin->ret("SELECT * FROM `locations` ");
                    while($row=$query->fetch(PDO::FETCH_ASSOC) ) { ?>
                        <tr>
                          ...
                          <td><a type="button" class="btn btn-info btn-rounded btn-fw" href="locationsupdate.php?upid=<?php echo $row['location_id'] ?>">Update</a></td>
                          <td><a type="button" class="btn btn-danger btn-rounded btn-fw" href="admincontroller/locationsadmin.php?delid=<?php echo $row['location_id'] ?>">Delete</a></td>
                         </tr>
                    <?php } ?>
                    <!--table data ends-->
                      </tbody>
          ...
          <!--insert button-->
          <a type="button" class="btn btn-success btn-rounded btn-fw" href="locationscreate.php">Add new location</a>
