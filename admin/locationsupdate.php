...
<?php
//getting php data 
$locid =$_GET['upid']; //this id is from locationsmain href
$query=$admin->ret("SELECT * FROM `locations` where `location_id`=".$locid);
          ...
          <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" autocomplete="off" method="POST" action="admincontroller/locationsadmin.php" enctype="multipart/form-data">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="location_name" value="<?php echo $row['location_name'] ?>" class="form-control" id="exampleInputUsername2" placeholder="location name">
                      </div>
                    </div>

                    <div class="form-group row">
                      <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Location Pincode</label>
                      <div class="col-sm-9">
                        <input type="text" name="location_pincode" value="<?php echo $row['location_pincode'] ?>" class="form-control" id="exampleInputEmail2" placeholder="location pincode">
                      </div>
                    </div>
