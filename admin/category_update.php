...
<?php
//getting php data 
$category_id =$_GET['category_update']; //this id is from locationsmain href
...
<div class="col-md-6 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="forms-sample" autocomplete="off" method="POST" action="admincontroller/category_controller.php" enctype="multipart/form-data">
                                    <div class="form-group row">
                                        <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Category Name</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="category_name" value="<?php echo $row['category_name'] ?>" class="form-control" id="exampleInputUsername2" placeholder="Category name">
                                        </div>
                                    </div>

                                    <!-- sending category id as hidden -->
