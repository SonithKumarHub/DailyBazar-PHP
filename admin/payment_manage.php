    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        ...
        <div class="content-wrapper">
                ...
                <div class="table-responsive">
                  <table class="table table-hover">
                    ...
                    <tbody>
                      ...
                      <!--table data starts -->
                      <?php $query = $admin->ret("SELECT * FROM ((`orders` INNER JOIN `customer` ON customer.cid = orders.cid_f) INNER JOIN `product` ON product.pid = orders.product_ido)  ");
                      while ($row = $query->fetch(PDO::FETCH_ASSOC)) { ?>
                        ...
                        <tr>
                          ...
                          <td><?php echo (($row['total_f'] * 10) / 100) ?></td>
                        </tr>
                      <?php } ?>
                      <!--table data ends-->
                    </tbody>
          ...
          <?php $a = 0;
          $query = $admin->ret("SELECT `total_f` FROM `orders` WHERE `cid_f`=$cid  " );
          while ($rowt = $query->fetch(PDO::FETCH_ASSOC)) {
            $a = $a + $rowt['total_f'];
          } ?>

          <h4 style="margin-left: 900px;">Total Amount:<?php echo $a ?> RS</h4>
