  ...
  <!--  # navbar / header -->
    ...
    <!--  #  sidebar   # -->
      ...
      <div class="main-panel"> <!--3. main panel starts-->
        ...
        <?php
          $query=$admin->ret("SELECT count(*) FROM `orders` where `owner_id`='$session_variable' ");
        ...
        <?php
          $query=$admin->ret("SELECT count(*) FROM `product` where `owner_pid`='$session_variable' ");
          $row1=$query->fetch(PDO::FETCH_ASSOC);
          $product=implode($row1);
          ?>
        <!-- customer counting ends -->
          ...
          <div class="col-md-6 mb-4 stretch-card transparent">
            <div class="card card-tale">
              <div class="card-body">
                ...
                <p class="fs-30 mb-2"><?php echo $o ?></p>
              </div>
            </div>
          </div>
          <div class="col-md-6 mb-4 stretch-card transparent">
            <div class="card card-dark-blue">
              <div class="card-body">
                ...
                <p class="fs-30 mb-2"><?php echo $product ?></p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
            <div class="card card-light-blue">
              <div class="card-body">
                ...
                <p class="fs-30 mb-2"><?php echo $locations ?></p>
              </div>
            </div>
          </div>
          <div class="col-md-6 stretch-card transparent">
            <div class="card card-light-danger">
              <div class="card-body">
                ...
                <p class="fs-30 mb-2"><?php echo $feedbacks ?></p>
              </div>
            </div>
          </div>
        </div>
