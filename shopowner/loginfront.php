      ...
      <div class="content-wrapper d-flex align-items-center auth px-0">
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            ...
            <h4 style="text-align:center; color:#4B49AC; font-family: Arial, sans-serif;"><b>Shop owner Login</b></h4>

              <form class="pt-3" action="ownercontroller/loginback.php" method="POST" autocomplete="off">
